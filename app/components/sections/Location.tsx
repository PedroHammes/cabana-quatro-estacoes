...
export default function Location(Props: {setOpen: (value: boolean) => void}) {
  ...
  ">
    ...
    ">
      {/* Card de cima */}
      <div className="
      relative rounded-2xl w-full md:w-6/10 h-full text-white
      flex flex-col
      p-4 lg:p-8
      gap-4 lg:gap-8
      ...
      ">
        ...
        <img src="/ux/06-location/location.png" alt="Como chegar" className="rounded-2xl"/>
