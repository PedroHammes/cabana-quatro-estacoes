...
export default function Location(Props: {setOpen: (value: boolean) => void}) {
  ...
  py-16 md:py-32 px-4 md:px-0 mx-4 md:mx-60
  ...
  ">
    ...
    ">
      {/* Card da esquerda */}
      <div className="w-full md:w-3/10 h-full">
        <iframe 
      ...
      {/* Card da direita */}
      <div className="relative rounded-2xl overflow-hidden w-full md:w-7/10 h-full">
        <Image
